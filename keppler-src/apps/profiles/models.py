...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name = _("phone Number"), max_length=30, default="+17806602639")
    about_me = models.TextField(verbose_name=_("About seller"), default="What would you like others to know about you as a seller?")
    ...
    is_customer = models.BooleanField(verbose_name=_("Customer"), default=False, help_text=_("Looking to buy a product?")) 
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=_("Looking to sell products?"))
